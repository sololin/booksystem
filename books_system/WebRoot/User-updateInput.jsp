    ...
    <center>
        <div class="rain">
			<div class="border start">
				...
				<form action="User-update" method="post" onsubmit="return checkForm()">
				<input type = "hidden" name = "u.id" value="<s:property value="u.id"/>"/>
					<label for="bookName">账号</label>
					<input name="u.userName" type="text" placeholder="账号" value="<s:property value="u.userName" />" onfocus="this.blur()"/>
                    <label for="email">密码</label>
					<input id="password" name="u.passWord" type="text" placeholder="密码" value="<s:property value="u.passWord"/>" />
                    <label for="email">学部</label>
					<input name="u.school" type="text" placeholder="学部" value="<s:property value="u.school" />" onfocus="this.blur()"/>
                    <label for="email"> 电话号码</label>
					<input id="telephone" name="u.telephone" type="text" placeholder="电话号码" value="<s:property value="u.telephone"/>"/>
