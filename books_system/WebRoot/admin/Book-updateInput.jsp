...
<head>
  ...
  <title>Glowform :: Image-less CSS3 Glowing Form Implementation</title>
    ...
    <center>
        <div class="rain">
			<div class="border start">
				...
				<form action="admin/Book-update" method="post" onsubmit="return checkForm()">
				<input type = "hidden" name = "book.id" value="<s:property value="book.id"/>"/>
				
					<label for="bookName">书名</label>
					<input id="bookName" name="book.bookName" type="text" placeholder="书名" value="<s:property value="book.bookName"/>"/>
                    <label for="email">作者</label>
					<input id="authod" name="book.authod" type="text" placeholder="作者" value="<s:property value="book.authod"/>"/>
                    <label for="email">出版社及版次</label>
					<input id="edition" name="book.edition" type="text" placeholder="出版社及版次" value="<s:property value="book.edition"/>"/>
                    <label for="email">出售价格</label>
					<input id="price" name="book.price" type="text" placeholder="出售价格" value="<s:property value="book.price"/>"/>
                    <label for="email">其他说明信息</label>
					<input id="description" name="book.description" type="text" placeholder="其他说明信息" value="<s:property value="book.description"/>"/>
